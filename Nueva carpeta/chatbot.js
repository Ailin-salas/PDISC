...
document.addEventListener('DOMContentLoaded', () => {
    ...
    toggleButton.addEventListener('click', () => {
        ...
        if (!chatbotWindow.classList.contains('hidden')) {
            ...
            if (messagesContainer.children.length === 0) {
                appendMessage('bot', '¡Hola! Soy tu asistente de MAPTV. ¿En qué puedo ayudarte hoy? Tengo respuestas sobre la creacion de Formularios de Torneos, Gracias');
            }
            // Enfocar el input
            inputField.focus();
        }
    ...
    const knowledgeBase = [
        ...
        // 2. Core: Creación de torneo
        { 
            keywords: ['torneo', 'crear', 'hacer un', 'mi torneo', 'empezar', 'crea'], 
            response: 'Para **crear tu torneo**, ve a la página principal y busca el botón de creación, o sino tambien en cualquier otra pagina le das al boton de crear en la barra de navegacion o "iniciar sesion" en el menu lateral. Es un proceso muy simple.' 
        },
        ...
        { 
            ...
            response: 'Puedes acceder y gestionar tu información, foto y ajustes en la página de **Perfil** (`perfil.html`).' 
        },
        { 
        ...
        { 
            ...
            response: 'La plataforma está construida con tecnologías web estándar: **HTML**, **CSS** (con variables) y **JavaScript** puro. Tambien utiliza mysql en **Prisma**.' 
        },
        { 
        ...
        { 
            keywords: ['que es MAPTV', 'nombre', 'significado', 'plataforma', 'empresa'], 
            response: '**MAPTV** es una plataforma para crear y gestionar tus torneos de forma simple, enfocada en un diseño estético y moderno.' 
        },
        { 
            keywords: ['mision', 'objetivo', 'proposito'], 
            response: 'Nuestro objetivo es simplificar la creación de torneos, ofreciendo herramientas sencillas y un diseño estético y moderno de temática gamer.' 
        },
        { 
